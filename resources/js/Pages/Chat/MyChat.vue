<template>
  ...
  <div class="p-6 space-y-4">
    <!-- Verifica si hay chats -->
    <div v-if="chats.length === 0" class="bg-red-100 text-red-800 p-4 rounded-lg">
      <p>No hay chats disponibles.</p>
    </div>

    <!-- Muestra los chats si hay alguno -->
    <div v-else>
      <div
        v-for="chat in chats"
        :key="chat.id"
      ...
      >
        <a :href="`/chats/${chat.id}`" class="block">
