  ...
  <div class="profile-container" :class="{ 'dark-mode': isDarkMode }">
    <div class="sidebar" :class="{ 'slide-in': slideIn }">
      <div class="profile-info">
        <img src="/images/logo.png" alt="Profile Image" class="profile-image">
...
export default {
  ...
  mounted() {
    SettingsScript.mounted.call(this);
  },
  methods: SettingsScript.methods
};
</script>

<style scoped src="/resources/css/Settings.css"></style>
